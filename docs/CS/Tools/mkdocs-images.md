...
- [Caption]
  ...
  [Attribute Lists]: https://squidfunk.github.io/mkdocs-material/setup/extensions/python-markdown.md#attribute-lists
  [Markdown in HTML]: https://squidfunk.github.io/mkdocs-material/setup/extensions/python-markdown.md#markdown-in-html
  [Caption]: https://squidfunk.github.io/mkdocs-material/setup/extensions/python-markdown-extensions.md#caption
...
!!! warning "Requirements when using [custom color schemes]"
  ...
  [color palette toggle]: https://squidfunk.github.io/mkdocs-material/setup/changing-the-colors.md#color-palette-toggle
  [Zelda light world]: https://squidfunk.github.io/mkdocs-material/assets/images/zelda-light-world.png#only-light
  [Zelda dark world]: https://squidfunk.github.io/mkdocs-material/assets/images/zelda-dark-world.png#only-dark
  [color schemes]: https://squidfunk.github.io/mkdocs-material/setup/changing-the-colors.md#color-scheme
  [custom color schemes]: https://squidfunk.github.io/mkdocs-material/setup/changing-the-colors.md#custom-color-schemes